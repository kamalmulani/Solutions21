...
{ id: 1,
  ...
  paragraph: "<b>GUIDELINES: </b><br>  <i> Participants have to register on both the sites i.e our site and coding ninja for this event.</i> <br>1. Individual Participation <br> 2.<b> All participants have to give both rounds, and the combined score of both  rounds will be considered.</b>  <br> <br> <b>Round 1:</b> <br> 1. Here the participants will have to find the bugs in small code. No compiler will be provided. <br> 2. This round will be for 1hr. <br> 3. Platform: CODING NINJA  <br><br> <b>Round 2:</b><br> 1. In this participants will debug the 2-4 full programs given to them. <br>  2. This round will be for 1hrs. <br> 3. In case of a tie, timing will be considered.",
...
{ id: 2,
  ...
  paragraph: "<b>GUIDELINES: </b><br><b>Round 1: </b> <br> 1. First round consists of MCQs which can be solved by coding.<br> 2. Time allotted:  30 min<br> <br><b> Round 2:</b>  <br> 1. The participants in the final round will be the selected from the first round.<br> 2. Participants have to write the code for pattern that maps input to output.<br> 3. In case of any discrepancy, the final verdict will be decided by the Event Head.",
  descriptionDown: "",
...
{ id: 3,
  ...
  prizeWorth: "5000/-",
  teamsize: "1",
  descriptionUp: "women coders or programmers need to be encouraged to continue with their chosen careers. And to increase the demand for top talent in the industry, new women programmers need to be brought into the system. with an aim to encourage them to take up programming.",
  paragraph: "Participants have to register on both the sites i.e our site and coding ninja for this event.",
  descriptionDown: "<b>GUIDELINES:</b> <br>1. Individual Participation<br>2. This round will be for 2hrs.<br>3. 3-4 Problems will be given. <br>4. Platform CODING NINJA",

},

{ id: 4,
  title: "NAND IT",
  img: "./image/nandIt.jpg",
  date: "To be declared",
  time: "To be declared",
  prizeWorth: "5000/-",
  teamsize: "1",
  descriptionUp: "Do you consider yourself as sharp or snappy? Do you always decide things instantly in Boolean? How often you use the words -registers, commands, ports, interrupts, timers, etc?<br> If you are astounded, you just have the passion for Embedded C which needs to be unleashed and we give you the right platform. Scrutinize problems and arrive at a solution. How interesting it sounds to run a motor at the desired speed, display data on LCD just with a few lines of codes?  <br>1. The decision of judges and organizers will be final and binding. <br>2. The coordinators have the right to change rules at any point of time before the  commencement of the event  <br> 3. Individual Participation <br>Participants can perform it either on online tinker or local proteus software.  <b>Tinkercad link:</b> <a href='https://www.tinkercad.com/'>https://www.tinkercad.com/</a> <br> Link to download Proteus: <a href='https://drive.google.com/file/d/1LAy-_Xvd8ucmW4RSJAiWcgNWUk2uz7_4/view'>https://drive.google.com/file/d/1LAy-_Xvd8ucmW4RSJAiWcgNWUk2uz7_4/view</a>",
  paragraph: "<br>ELIMINATIONS –</br><br> 1.	All the teams have to first pass the hurdle of prelims.<br> 2.	It will be a written test of simple multiple choice questions to assess participant's general knowledge about microcontrollers (8051, PIC or ARM). <br> 3.	There will be 40 MCQs on the basics of 8051 and PIC to be solved in 30 mins.<br><b> FINALS –</b><br> 1.	Here the top 8 teams from the first round will be provided with the problem statements which are to be implemented on the digital logic kits.<br> 2.	Time for this round will be  90 minutes. <br> 3.	The questions will be preferably from the basics of digital logic, DLD & DELD.<br> 4.	No of questions : 3.<br> 5.	Time bonus will be considered for tie-breaking between two or more teams.",
  descriptionDown: "<b>RULES:</b>  to be added",
...
{id: 6,
  ...
  prizeWorth: "5000/-",
  teamsize: "1",
  descriptionUp: "This event tests your skills in designing and modelling. Show your imagination and creativity at designing to become the ultimate CHAMPION.<br>1. Individual Participation<br> 2. 10 teams will make it to the finals. ",
  paragraph: "	The event will have 2 rounds <br> a.	<b>Round I- </b><br>I: Teams will be given MCQs to solve.<br> Timespan - 30 Minutes.<br> b.	<b> Round II -</b><br>1. The Final Round will be on CATIA and based on 3D.<br> 2. Time Duration: 60 Minutes.* *changes in the pattern can be made with prior notice.<br>3.The decision of the Judges will be FINAL and non-questionable",
  descriptionDown: " ",
...
{id: 7,
  ...
  teamsize: "1",
  descriptionUp: "",
  paragraph: "<b>	GUIDELINES:</b><br>1. Individual Participation  <br>2. 10 teams will make it to the finals  <br><b>Round I:</b> Teams will be given MCQs to solve. <br>Timespan - 30 Minutes. <br> <b>Round II:</b> Will be on AutoCAD software(use college id for login) /if you face an issue with AutoCAD download fusion 360 (<a href='https://www.autodesk.com/education/edu-software/overview?sorting=featured&amp;page=1'>https://www.autodesk.com/education/edu-software/overview?sorting=featured&amp;page=1</a> ) <br> The Final Round will be on AUTOCAD and based on orthographic projections and  isometric projections.",
...
teamsize: "1",
descriptionUp: "",
paragraph: "<b>Guidelines:</b><br>1. There will be one round only.<br>2. Individual Participation <br>3. Domain: Quantitative Aptitude, Reasoning, Maths.<br> <b>Details </b>1. Teams will be given MCQ aptitude questions, <b>30mins </b>will be given forsolving.",
descriptionDown: "",
...
prizeWorth: "4000/-",
teamsize: "1",
descriptionUp: "About:<br> <b>3X3 CUBE WILL BE USED</b><br> Participants can submit any number of videos, best will be considered. send your video on: <a href='mailto:aittechboard2020@gmail.com'>aittechboard2020@gmail.com</a> before<b> 24 MAY:</b><br>participants should be clearly visible in the video(not just hands).",
paragraph: "The <b>top 10</b> entries will be considered for the final.Where participants have to solve the cube in front of the camera.<b>Platform MS Teams</b>",
descriptionDown: "",
...
teamsize: "10-15",
descriptionUp: "",
paragraph: "<br>GUIDELINES:</br> <br> 1. The Ad should be original and any content from youtube or any other already available sources will lead to deduction of marks  <br>2. It should not have any kind of vulgar content or any content which can hurt the  feelings of any community/ person. <br> 3. All the students involved in the process should be included in the credits along with the year and college. <br> 4. Time limit is 2 +1 minutes. Negative marking will be done if the time limit is exceeded or lagged (5 points for every 5 seconds). <br>5. The participants have to submit their ad on or before 24 MAY before 12 pm to <a href='mailto:aittechboard2020@gmail.com'>aittechboard2020@gmail.com</a> 1 copy of abstract describing the theme and story of the movie. Failing to do so will lead to direct disqualification.<br>6. *changes in the pattern can be made with prior notice (min 2 days before the event) to the participants. <br> 7. Themes are <br> 1.<b> Covid awareness</b> <br> 2. <b>Promoting digital India in the field of healthcare.</b> <br> 3. Recreation with some modification is allowed.",
descriptionDown: "",
...
prizeWorth: "5000/-",
teamsize: "1",
descriptionUp: "Uniqueness, simplicity and how fast you can find the solution is the key for this competition!!! <br>Teams would be required to choose one of the specified themes; on the spot and come up a problem statement of their own based on the theme. Participants would then be required to give an innovative idea solution for the chosen problem statement keeping in mind the judging  ",
...
paragraph: "The event will be held in 3 Rounds:-<br>●	ROUND 1 : Screening Round <br> ●	ROUND 2 : Semi-Finals <br> ●	ROUND 3 : Finals <br> The difficulty level will increase with each level.",
descriptionDown: "RULES:<br> 1.	The criteria for judging are: accuracy, time limit & creativity.  <br>2.	Participants are advised to join 20 minutes prior to start time of the competition. <br>  3.	The decision of the judges shall be final and binding. <br> 4.	In case of any on the spot discrepancy, the decision of the organizers will be considered final.",
...
prizeWorth: "5000/-",
teamsize: "1",
descriptionUp: "<b>Do you think you know a lot about robotics? Check your knowledge with this interesting quiz… </b> <br>Participants will be provided with the option to choose any of the four given topics they want to give quiz of. An option to choose miscellaneous will also be provided. The quiz link of the topic they choose will be mailed when the event starts. Question type You will be given 20 questions and each question will have certain time limits. The questions will be of these types: <br>1. Multiple choice questions <br> 2. Jeopardy <br> 3. An image of Machine will be given and participants have to choose the correct images from the options of which the machine is made of.",
paragraph: "<b>RESULT </b> <br>The result will be based on how fast and accurate participants answer the questions. ",
descriptionDown: "<b>RULES:</b><br>1. Participants are advised to join 20 minutes prior to start time of the com<br> 2. The decision of the judges shall be final and binding.<br>3. In case of any on the spot discrepancy, the decision of the organizers will be considered final",

},

{id: 22,
title: "<b><u>Innovation Challenge: A Day in a Startup</b></u>",
img: "./image/eCellInovation.jpg",
date: "To be declared",
time: "To be declared",
prizeWorth: "6000/-",
teamsize: "1-4",
descriptionUp: "<b>Event Structure:</b><br><b>Teams need to make submission in proposed manner:</b><br>Get your original idea transformed and compete into the event. Submit a working prototype along with the Business Plan for your idea.",
paragraph: "<b>Rulebook in detail:<><br>1. Intercollege event<br>2. Team size: 1-4 students (no restriction on Year of study)<br> 3. All team members should be present at the event <br>4. All work on a project should be done in the prototype preparation phase.<br>5. Teams can use an idea they had before the event.<br>6. Judging criteria: Teams will be judged on these four criteria. Judges will weigh the criteria equally. During judging, participants should try to describe what they did for each criterion in their prototype.<br><br><b>a. Technology:</b><br>How technically impressive was the idea?<br>Was the technical problem the team tackled difficult?<br>Did it use a particularly clever technique or did it use many different components?<br> <br><b> b. Design:</b><br>Did the team put thought into the user experience?<br> How well designed is the interface?<br>For a hardware project, it might be more about how good human-computerinteraction is.<br><br> <b> c. Completion:</b>Does the prototype work?<br>Is it feasible?<br> Did the team achieve everything they wanted?<br> <br><b>d. Learning:</b>Did the team stretch themselves?<br>Did they try to learn something new?<br>What kind of projects have they worked on before?<br><br><b>e. Prototype:</b><br>You are strongly encouraged to present a prototype along with a business plan of what you have built. Presentations are discouraged.<br><br><b>14. Business Model and Plan</b> <br> Stats and data on economics and complexity of the solution. All general rules for business plans must be followed.<br>15. Teams can be disqualified from the competition at the organizers&#39; discretion. Reasons might include but are not limited to breaking the Competition Rules or other unsporting behavior.<br>16. Updated information related to the event will be email-d to the participants before time><br>17. These criteria will guide judges but ultimately judges are free to make decisions based on their gut feeling of which projects are the most impressive and most deserving.<br>",
descriptionDown: "to be added",

},

{id: 23,
title: "<b><u>Startup Challenge: A Day in a Startup</b></u>",
img: "./image/eCellStartup.jpg",
date: "To be declared",
time: "To be declared",
prizeWorth: "5000/-",
teamsize: "1-2",
descriptionUp: "<b>Event Structure:</b><br>Work on the real-world problems faced by startups. Build prototype and presentation. Problems will be released by ecell 3-5 days prior to the event.",
paragraph: "<b>Rulebook in detail:</b><br>1. Intercollege event<br> 2. Team size: 1-4 students (no restriction on Year of study)<br> 3. All team members should be present at the event<br> 4. All work on a project should be done in the prototype preparation phase.<br> 5. Teams are discouraged to use their own idea. They specifically need to work on problems proposed only.<br> 6. Two-hour window will be open for the teams to interact with the judges related to their problem domain.<br>7. Judging criteria: Teams will be judged on these four criteria. Judges will weigh the criteria equally. During judging, participants should try to describe what they did for each criterion in their prototype.<br><b>a. Technology:</b> How technically impressive was the idea?<br>  Was the technical problem the team tackled difficult?<br></br>  Did it use a particularly clever technique or did it use many different components?<br><b>b. Design:</b>  Did the team put thought into the user experience?<br><br> How well designed is the interface?<br> For a hardware project, it might be more about how good human-computer interaction is.<br> <br><b> c. Completion:</b><br> Does the prototype work?<br> Is it feasible?<br> Did the team achieve everything they wanted?<br> <b>d. Learning:</b>  Did the team stretch themselves?. <br> Did they try to learn something new?. <br> What kind of projects have they worked on before?. <br> <br><b>e. Prototype:</b>You are strongly encouraged to present a prototype of what you have built.<br> Only including presentations are discouraged. You are not judged on the quality of your idea. As you are judged on what you built, you'll only hurt yourself by not showing a demo.<br> You are encouraged to present what you have done even if your prototype is broken or you weren’t able to finish.<br><br> 8. Teams can be disqualified from the competition at the organizers&#39; discretion. Reasons might include but are not limited to breaking the Competition Rules or other unsporting behavior.<br> 9. Updated information related to the event will be email-d to the participants before time<br>10. These criteria will guide judges but ultimately judges are free to make decisions based on their gut feeling of which projects are the most impressive and most deserving.",
descriptionDown: "<i> Performance-based internships will be offered to teams irrespective of their rank.</i>",

},

{id: 24,
title: "<br><u>ByPass CTF</u></br1.>",
img: "./image/isdf.png",
date: "To be declared",
time: "To be declared",
prizeWorth: "5000/-",
teamsize: "1-4",
descriptionUp: "",
paragraph: "<b>RULES:</b></br> 1.This is a Jeopardy Style CTF Competition and you can participate as an individual or team of max size 4.<br>2.Hate speech, racism, and other inappropriate conduct will be met with adisqualification.<br>3.Attacking the infrastructure is against the rules. If you are not sure what belongs to a particular challenge, ask.<br>4.Act according to the general rules of playing a CTF (no flag sharing, asking for flags,flag hoarding, spoiling the solutions...)<br> 5.If there is something wrong with a challenge you are solving, PM the author of thatchallenge on our Discord Server.",
descriptionDown: "",

},
{id: 25,
  title: "<b><u>TROUBLESHOOTING THE ENCLOSURE</b></u>",
  img: "./image/troubleShooting.jpg",
  date: "To be declared",
  time: "To be declared",
  prizeWorth: "5000/-",
  teamsize: "1",
  descriptionUp: "<b>Do you think you are good enough to practice the idea of robotics in your daily life?</b><br><br>If yes, then this event is for you You would be accustomed to solve given problem statements. How about creating your own problem statement? &nbsp Sounds Interesting? Let’s see…<br><br>The participants will be assigned a random part of the house based on our algorithm and they have to create their own problem statement for that part of your house (for example-  In the kitchen a problem statement could be automation of exhaust fans). You'll have to work on providing an efficient solution to the problem. Keep in mind, someone might think alike, so the more unique your solution is the more chances of your winning are.",
  paragraph: "The event will be held in two levels:-<br>●	ROUND 1 :IDEA-SOLUTION ROUND<br>●	ROUND 2 :SIMULATION ROUND",
