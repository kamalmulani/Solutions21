...
var eventDetails = [
  {
    ...
    paragraph:  "The event will be held in two levels: -<br> Junior Level  –  FE-SE <br> Senior Level – TE-BE <br> For each level there will be two rounds. <br> Round 1: <br> First round of both the formats will be of multiple choice questions round based on C/C++.<br> Number of Questions:  20<br> Time Allotted:  30 min <br> Round 2: <br> 1. The teams in the final round will be the selected teams from the first round.<br>  2. Programming problems have to be solved on computer.<br> 3. Each team will be provided one computer only. <br> 4. Second round will be hosted on Codechef and all programs will be run and compiled online.",
    descriptionDown:  "RULES:  to be added",
  },
  ...
  { id: 1,
    ...
    paragraph: "Round 1: <br> 1. Here the teams will have to find the bugs in 20 small codes in notepad file. No compiler will be provided.<br> 2. This round will be for 30 minutes.<br> 3. +2 marks for each error or warning detection with reason and +1 for only error detection.<br> 4. -1 for incorrect error detection and no negative marking if any error is not detected.<br> 5. There will be no logical errors.<br> Round 2: <br> 1. In this the top 10 teams will debug the 2 full programs given to them.<br> 2. This round will be for 2hrs.<br> 3. Only logical error to be detected.<br> 4.  For each error detection+1 mark will be given.<br> 5. +20 mark if the code runs correctly with proper output.<br> 6. In case of a tie, timing will be considered.",
    descriptionDown: "RULES:  to be added",
  ...
  {id: 7,
    ...
    teamsize: "2",
    descriptionUp: "",
    paragraph: "Round I: <br> MCQs <br> Teams will be given MCQs to solve.<br> 30 questions in time span of 30 Minutes.*<br> <br> Round II: <br> Final Round will be on AUTOCAD and based on orthographic projections and isometric projections.",
    descriptionDown: "RULES:  Time Duration:  60 Minutes.*<br> *changes in the pattern can be made with a prior notice (min 2 days before the event) to the branch heads.<br> *decision of the Judges will be FINAL and non-questionable. ",
