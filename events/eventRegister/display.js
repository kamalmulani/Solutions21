...
{id: 7,
  ...
  teamsize: "1",
  descriptionUp: "",
  paragraph: "<b>	GUIDELINES:</b><br>1. Individual Participation  <br>2. 10 teams will make it to the finals  <br><b>Round I:</b> Teams will be given MCQs to solve. <br>Timespan - 30 Minutes. <br> <b>Round II:</b> Will be on AutoCAD software(use college id for login) /if you face an issue with AutoCAD download fusion 360 (https://www.autodesk.com/education/edu-software/overview?sorting=featured&amp;page=1) <br> The Final Round will be on AUTOCAD and based on orthographic projections and  isometric projections.",
...
prizeWorth: "4000/-",
teamsize: "1",
descriptionUp: "About:<br> <b>3X3 CUBE WILL BE USED</b><br> Participants can submit any number of videos, best will be considered. send your video on: <a href=>aittechboard2020@gmail.com</a>before<b> 24 MAY:</b><br>participants should be clearly visible in the video(not just hands).",
...
teamsize: "10-15",
descriptionUp: "",
paragraph: "<br>GUIDELINES:</br> <br> 1. The Ad should be original and any content from youtube or any other already available sources will lead to deduction of marks  <br>2. It should not have any kind of vulgar content or any content which can hurt the  feelings of any community/ person. <br> 3. All the students involved in the process should be included in the credits along with the year and college. <br> 4. Time limit is 2 +1 minutes. Negative marking will be done if the time limit is exceeded or lagged (5 points for every 5 seconds). <br>5. The participants have to submit their ad on or before 24 MAY before 12 pm to aittechboard2020@gmail.com 1 copy of abstract describing the theme and story of the movie. Failing to do so will lead to direct disqualification.<br>6. *changes in the pattern can be made with prior notice (min 2 days before the event) to the participants. <br> 7. Themes are <br> 1.<b> Covid awareness</b> <br> 2. <b>Promoting digital India in the field of healthcare.</b> <br> 3. Recreation with some modification is allowed.",
descriptionDown: "",
